<template>
  <div :class="checkboxStyle.base()">
    <div class="relative flex flex-col">
      ...
      />
      <svg
        :class="checkboxStyle.checkboxIcon()"
        viewBox="0 0 16 16"
        fill="none"
...
const checkboxTV = tv({
  slots: {
    ...
    checkboxIcon: 'pointer-events-none absolute transition-all duration-300 peer-disabled:cursor-not-allowed'
  },
  variants: {
    variant: {
      default: {
        ...
        checkboxIcon: '-rotate-90 fill-white stroke-white opacity-0 peer-checked:rotate-0 peer-checked:opacity-100'
      }
    },
    invalid: {
      true: {
        checkbox:
          'border-red-500 checked:border-red-500 checked:bg-red-500 checked:hover:border-red-600 checked:hover:bg-red-600'
      }
    },
    size: {
      sm: {
        ...
        checkboxIcon: 'left-0 top-0 h-3.5 w-3.5'
      },
      md: {
        checkbox: 'h-4 w-4',
        label: 'text-md pl-2',
        small: 'py-0.5 pl-[26px] text-xs',
        checkboxIcon: 'left-0 top-0 h-4 w-4'
      },
      lg: {
        checkbox: 'h-5 w-5',
        label: 'pl-2 text-lg',
        small: 'py-0.5 pl-[30px] text-xs',
        checkboxIcon: 'left-0 top-0 h-5 w-5'
      }
    }
  },
  defaultVariants: {
